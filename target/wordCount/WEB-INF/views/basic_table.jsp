...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index" class="logo">Stat <span class="lite"></span></a>
            <!--logo end-->
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li id="mail_notificatoin_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="resources/avatar-mini.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="resources/avatar-mini2.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="resources/avatar-mini3.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="resources/avatar-mini4.jpg"></span>
                                    <span class="subject">
